...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: endo());
  }
}

class endo extends StatefulWidget {
  @override
  endoState createState() => endoState();
}

class endoState extends State<endo> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Suivi des troubles thyroïdiens'),
                  const SizedBox(height: 20),
                  _buildOption('Hyperparathyroïdie'),
                  const SizedBox(height: 20),
                  _buildOption('Échographies et test HM'),
                  const SizedBox(height: 20),
                  _buildOption('Traitement du diabète'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
