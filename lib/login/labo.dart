...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: labo());
  }
}

class labo extends StatefulWidget {
  @override
  laboState createState() => laboState();
}

class laboState extends State<labo> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Analyses de sang'),
                  const SizedBox(height: 20),
                  _buildOption('Tests de pathologie'),
                  const SizedBox(height: 20),
                  _buildOption('Analyses de selles'),
                  const SizedBox(height: 20),
                  _buildOption('Tests michrobiologiques'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
