...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: Dermo());
  }
}
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Traitement des cicatrices'),
                  const SizedBox(height: 20),
                  _buildOption('Cryothérapie'),
                  const SizedBox(height: 20),
                  _buildOption('Traitement au laser'),
                  const SizedBox(height: 20),
                  _buildOption('Dermatologie esthétique'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
