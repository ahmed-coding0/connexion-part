...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: orl());
  }
}

class orl extends StatefulWidget {
  @override
  orlState createState() => orlState();
}

class orlState extends State<orl> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Chirurgie esthétique'),
                  ...
                  const SizedBox(height: 20),
                  _buildOption('Rééducation vocale'),
                  const SizedBox(height: 20),
                  _buildOption('Immunothérapie'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
