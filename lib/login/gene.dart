...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: gene());
  }
}

class gene extends StatefulWidget {
  @override
  geneState createState() => geneState();
}

class geneState extends State<gene> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Consultations de routine'),
                  const SizedBox(height: 20),
                  _buildOption('Vaccination et prévention'),
                  const SizedBox(height: 20),
                  _buildOption('Soins d’urgence et premier secours'),
                  const SizedBox(height: 20),
                  _buildOption('Orientation vers des spécialistes'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
