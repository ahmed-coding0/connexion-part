...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: CIM());
  }
}

class CIM extends StatefulWidget {
  @override
  CIMState createState() => CIMState();
}

class CIMState extends State<CIM> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Radiographie'),
                  const SizedBox(height: 20),
                  _buildOption('Echographie'),
                  const SizedBox(height: 20),
                  _buildOption('Mammographie'),
                  const SizedBox(height: 20),
                  _buildOption('IRM /TDM'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
