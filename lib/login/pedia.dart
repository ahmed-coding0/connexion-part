...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: pedia());
  }
}

class pedia extends StatefulWidget {
  @override
  pediaState createState() => pediaState();
}

class pediaState extends State<pedia> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Urgence pédiatrique'),
                  const SizedBox(height: 20),
                  _buildOption('Soins de nourrissons'),
                  const SizedBox(height: 20),
                  _buildOption('Conseils en psycologie'),
                  const SizedBox(height: 20),
