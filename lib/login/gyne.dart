...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: Gyne());
  }
}

class Gyne extends StatefulWidget {
  @override
  GyneState createState() => GyneState();
}

class GyneState extends State<Gyne> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildOption('Chirurgie gynécologique'),
                  const SizedBox(height: 20),
                  _buildOption('Traitement des IV et des MST'),
                  const SizedBox(height: 20),
                  _buildOption('Soins sur la contraception'),
                  const Spacer(),
                  Center(
                    child: SizedBox(
                      width: 200,
